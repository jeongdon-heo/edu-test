...
어조는 전문적이고 객관적이어야 하며, 다음 3가지를 반드시 포함하여 각 항목당 3~4문장으로 요약해 주세요:
1) 강점 및 성취 수준: 정답을 바탕으로 학생이 잘 이해하고 있는 핵심 개념
2) 취약점 및 오개념: 오답을 바탕으로 학생이 헷갈려 하거나 부족한 부분
3) 지도 조언: 이 학생을 위해 교사가 어떤 부분을 보충 지도하거나 어떤 발문을 던지면 좋을지

반드시 아래 JSON 형식으로만 응답하세요. 마크다운 코드 블록, 설명 문장, 인사말을 절대 포함하지 마세요.

{
  "strength": "강점 및 성취 수준 (3~4문장)",
  "weakness": "취약점 및 오개념 (3~4문장)",
  "guidance": "지도 조언 (3~4문장)"
}`;
